...
structure Instr =
  struct
    ...
    fun toString instr =
      ...
      | if_icmpne offset  => "if_icmpne"
      | if_icmplt offset  => "if_icmplt"
      | if_icmpge offset  => "if_icmpge"
      | if_icmpgt offset  => "if_icmpgt"
      | if_icmple offset  => "if_icmple"
      | if_acmpeq offset  => "if_acmpeq"
      | if_acmpne offset  => "if_acmpne"
      ...
      | new className     => "new"
      | newarray _        => "newarray"
      | anewarray index   => "anewarray"
      | arraylength       => "arraylength"
      | athrow            => "athrow"
      | checkcast index   => "checkcast"
      | instanceof index  => "instanceof"
      ...
      | ifnull offset     => "ifnull"
      | ifnonnull offset  => "ifnonnull"
      | goto_w offset     => "goto_w"
      | jsr_w offset      => "jsr_w"
